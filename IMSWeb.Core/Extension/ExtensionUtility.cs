...
namespace IMSWeb.Core
{
    public static class ExtensionUtility
    {
        ...
        public static System.Data.DataTable ToDataTable<TSource>(this IList<TSource> data)
        {
        ...
        public static List<TSource> ToList<TSource>(this DataTable dataTable) where TSource : new()
        {
            ...
            if (dataTable == null) return dataList;
            ...
            {
                if (obj.Type == typeof(System.Single))
                    commonFields.Add(obj);
