...
namespace IMSWeb.App_Start
{
    public class MVCGridConfig
    {
        public static void RegisterGrids()
        {
            ...
            MVCGridDefinitionTable.Add("WithMobileBday", new MVCGridBuilder<Client>(colDefauls)
                          .WithAuthorizationType(AuthorizationType.AllowAnonymous)
                          .WithSorting(sorting: true, defaultSortColumn: "Clientname", defaultSortDirection: SortDirection.Dsc)
                          .WithPaging(paging: true, itemsPerPage: 10, allowChangePageSize: true, maxItemsPerPage: 100)
                          .WithAdditionalQueryOptionNames("search")
                          ...
                          .WithRetrieveDataMethod((context) =>
                          {
                              ...
                              var items = repo.GetWithMobileBday(out totalRecords, globalSearch, options.GetLimitOffset(), options.GetLimitRowcount(),
                                  sortColumn, options.SortDirection == SortDirection.Dsc);
            ...
            MVCGridDefinitionTable.Add("WithMobileEmail", new MVCGridBuilder<Client>(colDefauls)
                                      .WithAuthorizationType(AuthorizationType.AllowAnonymous)
                                      .WithSorting(sorting: true, defaultSortColumn: "Clientname", defaultSortDirection: SortDirection.Dsc)
                                      .WithPaging(paging: true, itemsPerPage: 10, allowChangePageSize: true, maxItemsPerPage: 100)
                                      .WithAdditionalQueryOptionNames("search")
                               ...
                               string globalSearch = options.GetAdditionalQueryOptionString("search");
                                          ...
                                          var items = repo.GetWithMobileEmail(out totalRecords, globalSearch, options.GetLimitOffset(), options.GetLimitRowcount(),
                                              sortColumn, options.SortDirection == SortDirection.Dsc);
